...
# create a list of identifiers of all cities (called cities in the
# code below),and from there on iteratively pick
# a city from that list at random and add it to our solution
